...
def train_nb(train_dataloader, test_dataloader):
    ...
    for i in range(epoch):
        ...
        for batch_data in train_dataloader:
            ...
            for features, labels in zip(encoded_fusion, labels):
                predictions = nb_model.predict(features)  # 对单个样本进行预测
        ...
        if epoch_accuracy > best_train_accuracy:
            ...
            # 保存最优模型
            joblib.dump(nb_model, "./model_save/NB_best_train_model.pkl")
        ...
        if test_accuracy > best_test_accuracy:
            ...
            joblib.dump(nb_model, "./model_save/NB_best_test_model.pkl")
            print("-----------------!!!!!!!!!!!!!!!!!!第 {} 轮的ACC最优!!!!!!!!!!!!!!!!!!!-----------------".format(i + 1))

if __name__ == '__main__':
    train_nb(train_dataloader, test_dataloader)